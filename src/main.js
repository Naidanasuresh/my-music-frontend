...
articles.forEach((article)=>{
    article.addEventListener('click', async ()=>{
        ...
        if(category==='Heart Break'){
            songscategoryposter.src='public/download (10).jpg'

        }

        else if(category==="Love"){
            songscategoryposter.src='public/download (6).jpg'
        }
        else if(category==='Motivation'){
            songscategoryposter.src='public/Tommy Shelby Motivation🔥.jpg'

        }
        else{
            songscategoryposter.src='public/kollywood music.jpg'
        }
